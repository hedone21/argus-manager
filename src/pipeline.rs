...
use argus_shared::{EngineCommand, EngineDirective, EngineMessage, QcfEstimate, SystemSignal};
...
mod hierarchical {
    ...
    mod tests {
        ...
        fn make_heartbeat_msg(
            ...
            device: &str,
            eviction_policy: &str,
        ) -> argus_shared::EngineMessage {
            use argus_shared::{EngineMessage, EngineState, EngineStatus, ResourceLevel};
        ...
        fn non_heartbeat_message_does_not_change_engine_state() {
            use crate::types::feature;
            use argus_shared::{CommandResponse, CommandResult, EngineCapability, EngineMessage};
            let mut p = make_pipeline();
        ...
        fn test_compute_raw_metric_cpu_only_builds_pressure() {
            ...
            let sig = SystemSignal::ComputeGuidance {
                ...
                recommended_backend: argus_shared::RecommendedBackend::Any,
                reason: argus_shared::ComputeReason::Balanced,
                cpu_usage_pct: 95.0,
                gpu_usage_pct: 0.0,
            };
            for _ in 0..5 {
        ...
        fn test_seq_097_qcf_estimate_triggers_action_selection() {
            ...
            let qcf = argus_shared::QcfEstimate {
                estimates: {
